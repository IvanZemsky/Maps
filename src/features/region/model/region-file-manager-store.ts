...
export const useRegionFileManagerStore = defineStore("regions", () => {
   ...
   async function loadRegionFromFile(event: Event) {
      ...
      try {
         return await parseRegionFile(file)
      } catch (error) {
   ...
   return { region, errorMessage, parseRegionFile, loadRegionFromFile, saveRegionToFile }
})
